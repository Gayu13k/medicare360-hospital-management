...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
      <div
        className={`relative w-full ${maxWidthClass} bg-[#121212] rounded-2xl shadow-2xl border border-white/10 overflow-hidden my-8 max-h-[90vh] flex flex-col text-zinc-100`}
      >
